public class Eternal : Goal {
    ...
    public Eternal(string name, string description, int pointAmount, bool isComplete) : base(name, description, pointAmount, isComplete) {
    ...
    public override string GetGoal(bool forScreen)
    {
        ...
        if (forScreen) {
            ...
            retVal = ($"EternalGoal~{this.Name}~{this.Description}~{this.PointAmount}~{this.IsComplete}");
        }
